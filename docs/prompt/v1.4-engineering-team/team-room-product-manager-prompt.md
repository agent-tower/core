...
- 在方案设计时，如果需求涉及多步骤流程、角色协作、状态变化、权限分支或异常路径，应优先用流程图辅助说明，让用户、负责人和技术团队负责人能快速理解主流程、关键分支和边界。
...
- 非目标。
- 用户故事或关键流程。
- 方案流程图：当需求包含多步骤流程、关键分支、状态变化、角色协作或异常路径时，用流程图说明主流程、分支和失败路径；简单需求可以说明不需要流程图。
- 验收标准。
- 方案选项与推荐。
- 风险 / 取舍。
- 依赖 / 假设。

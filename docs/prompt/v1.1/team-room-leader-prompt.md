...
```
我会先让架构师确认方案边界，再让实现工程师处理后端调度。你现在不需要做选择；如果方案里出现取舍，我会再回来确认。
```
...
1. 先做最小改动，把功能尽快跑通。风险低，后续如果规模变大再优化。
2. 这次顺便做一轮底层整理。后续更稳，但本轮时间更长、变更更大。

...
export const messages: Record<AppLocale, Record<string, string>> = {
  'zh-CN': {
    ...
    'The agent needs approval to continue.': 'Agent 需要你的授权才能继续。',
    'Confirm': '确认',
    'Cancel': '取消',
    'Start': '开始',
    'Starting...': '启动中...',
    ...
    'Download file': '下载文件',
    'Viewing agent visualization': '正在查看 Agent 可视化',
    'Session file': '会话文件',
    'Coming soon...': '即将推出...',
    'Modified': '已修改',
    'Added': '已新增',
    ...
    '正在思考': '正在思考',
    '最后一次输出于 {duration}前': '最后一次输出于 {duration}前',
    '等待首次输出': '等待首次输出',
    '{count} 秒': '{count} 秒',
    '{minutes} 分 {seconds} 秒': '{minutes} 分 {seconds} 秒',
    '{hours} 小时 {minutes} 分': '{hours} 小时 {minutes} 分',
    ...
    'Interactive terminals': '交互终端',
    'Background services': '后台服务',
    'Background service logs': '后台服务日志',
    'Loading background services...': '正在加载后台服务...',
    'Failed to load background services.': '加载后台服务失败。',
    'No background services': '暂无后台服务',
    'Select a background service': '选择一个后台服务',
    'Loading service logs...': '正在加载服务日志...',
    'Failed to refresh service logs.': '刷新服务日志失败。',
    ...
    'Paste terminal input here': '在此粘贴终端输入内容',
    'Terminal paste content': '终端粘贴内容',
    'Terminal is not ready': '终端尚未就绪',
    'Pasted into terminal': '已粘贴到终端',
    'Paste': '粘贴',
    'Disconnected': '未连接',
    'Connecting...': '连接中...',
    'Connected': '已连接',
    ...
    'Creating session': '正在创建会话',
    'Starting agent': '正在启动 Agent',
    'Starting task': '正在启动任务',
    'Agent start failed': '启动 Agent 失败',
    'Preparing workspace': '准备工作空间',
    'Run setup script': '执行 Setup 脚本',
    'Running setup ({current}/{total})': '正在执行 Setup（{current}/{total}）',
    'Setup complete': 'Setup 完成',
    'View setup output': '查看 Setup 输出',
    'Hide setup output': '收起 Setup 输出',
    'Setup failed': 'Setup 失败',
    'More details': '更多详情',
    'Hide details': '收起详情',
    'Retry start': '重试启动 Agent',
    'Workspace setup is running in the background.': '工作空间正在后台准备。',
  ...
  en: {
    ...
    '工具调用': 'Tool Calls',
    '已处理': 'Processed',
    '已处理 {duration}': 'Processed {duration}',
    '正在思考': 'Thinking',
    '最后一次输出于 {duration}前': 'Last output {duration} ago',
    '等待首次输出': 'Waiting for the first output',
    '{count} 秒': '{count}s',
    ...
    '紧急': 'Urgent',
    '普通': 'Normal',
    '优先级变更失败': 'Failed to update task priority',
    ...
    '自动批准操作（YOLO）': 'Auto-approve Actions (YOLO)',
    '模型': 'Model',
    ...
    'API 地址': 'API URL',
    '请输入以 http:// 或 https:// 开头的完整 API 地址': 'Enter a complete API URL beginning with http:// or https://.',
    '输入 API Key': 'Enter API Key',
    '未配置': 'Not configured',
    '由高级配置管理': 'Managed in advanced configuration',
    '替换': 'Replace',
    '取消替换': 'Cancel replacement',
    '确定清除此 API Key？': 'Clear this API key?',
    ...
    '超高': 'Extra high',
    '最高': 'Maximum',
    '请选择当前 Agent 支持的思考强度档位': 'Choose a reasoning effort supported by this agent.',
    '测试配置': 'Test Configuration',
    '测试中...': 'Testing...',
    '保存 Provider': 'Save Provider',
    '高级配置': 'Advanced Configuration',
    '执行权限': 'Execution Permission',
    '禁用 WebSocket': 'Disable WebSocket',
    '仅禁用 Codex Responses API 的 WebSocket 传输；新启动和后续继续的请求将使用 HTTP。':
      'Disable only the Codex Responses API WebSocket transport. New sessions and follow-ups will use HTTP.',
    '当前原生 Provider 已使用非 WebSocket 传输；此开关不会添加额外运行时覆盖。':
      'The current native provider already uses a non-WebSocket transport. This switch adds no runtime override.',
    '禁用 WebSocket 字段必须为 true 或 false，请在运行配置 JSON 中修正。':
      'The Disable WebSocket field must be true or false. Correct it in the runtime JSON.',
    '高风险执行已开启': 'High-risk execution enabled',
    'Agent 将不再请求工具执行权限确认。': 'The agent will no longer ask for tool execution permission.',
    'Agent 将自动批准操作，不再逐项请求确认。': 'The agent will approve operations automatically without asking for each action.',
    'Agent 将以强制模式执行操作。': 'The agent will execute operations in force mode.',
    'Agent 将拥有完全访问电脑的权限': 'The agent will have full access to this computer.',
    '执行权限字段必须为 true 或 false，请在运行配置 JSON 中修正。': 'The execution permission field must be true or false. Correct it in the runtime JSON.',
    '开启高风险执行权限？': 'Enable high-risk execution permission?',
    '确认开启': 'Enable',
    '配置错误：权限字段必须为布尔值': 'Configuration error: the permission field must be a boolean.',
    '配置错误': 'Configuration error',
    '权限已开启': 'Enabled',
    '权限已关闭': 'Disabled',
    '运行配置 (JSON)': 'Runtime Configuration (JSON)',
    '配置检查通过': 'Configuration check passed',
    '连接测试通过': 'Connection test passed',
    '本机可用性检查通过': 'Local availability check passed',
    '配置检查未通过': 'Configuration check did not pass',
    '测试对象': 'Test target',
    '测试时间': 'Tested at',
    '需要解决配置冲突': 'Configuration conflicts must be resolved',
    '简化字段与高级配置值不同': 'The simplified and advanced values differ',
    '采用简化值': 'Use simplified value',
    '保留高级值': 'Keep advanced value',
    '测试失败不会阻止保存。': 'A failed test does not prevent saving.',
    '测试配置失败': 'Configuration test failed',
    '存在未保存的修改，确定放弃吗？': 'Discard the unsaved changes?',
    '切换 Agent 类型会清空当前类型的配置，是否继续？':
      'Changing the agent type clears the current type-specific configuration. Continue?',
    'JSON 顶层必须是对象': 'The top-level JSON value must be an object.',
    '{format} 语法错误: {message}': 'Invalid {format} syntax: {message}',
    '已配置，输入新值以替换': 'Configured. Enter a new value to replace it.',
    '权限策略': 'Permission Policy',
    '每次询问': 'Ask Every Time',
    '无限制': 'Unrestricted',
    'ACP 权限策略必须为 ASK 或 UNRESTRICTED': 'ACP permission policy must be ASK or UNRESTRICTED',
    ...
    'Agent 原生配置 (config.toml)': 'Native Agent Config (config.toml)',
    'Agent 原生配置 (settings.json)': 'Native Agent Config (settings.json)',
    '直接填写 Codex': 'Enter a Codex',
    '格式的配置片段，由当前 Runtime 注入。不会修改你的':
      'configuration snippet. The selected runtime injects it without modifying your',
    ...
    '由当前 Runtime 注入。在': '. The selected runtime injects it. Configure',
    ...
    '该 Provider 未配置额外参数。点击"编辑"添加运行配置、环境变量或 Agent 原生配置。':
      'This provider has no extra parameters configured. Click "Edit" to add runtime configuration, environment variables, or native agent configuration.',
    '个变体': 'variants',
    '个文件': 'files',
    ...
    'CLI 配置': 'CLI Config',
    'Agent 原生配置': 'Native Agent Config',

    ...
    case LogType.Action:
      return (
        <div className="flex items-start gap-4 py-3 animate-in fade-in duration-300">
          ...
          <div className="text-neutral-800 leading-relaxed font-medium whitespace-pre-wrap">
            {log.content}
          </div>
        </div>
      )
      ...
      return (
        <div className="my-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
          <div className="border border-neutral-200 rounded-sm overflow-hidden">
            ...
            <div className="px-4 py-3 bg-white text-neutral-800 leading-relaxed whitespace-pre-wrap">
              {log.content}
            </div>
          </div>
        </div>
